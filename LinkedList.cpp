...
public:
    ...
    linked_list* Search(string bidId);
    int Size();
};
...
void LinkedList::PrintList() {
	...
	linked_list *curr_list = head;
	cout << curr_list->data.bidId;
	cout << curr_list->data.title;
	cout << curr_list->data.fund;
	cout << curr_list->data.amount;
 ...
 */
linked_list* LinkedList::Search(string bidId) {
